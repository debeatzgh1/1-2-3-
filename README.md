<style>
    ...
    <div id="iframe-overlay" onclick="closeHustleKit(event)">
        <div class="iframe-container" onclick="event.stopPropagation()">
            ...
            <iframe src="https://debeatzgh1.github.io/Digital-Creator-s-Essential-Guides-Tools/" title="Side Hustle Starter Kit"></iframe>
        </div>
    </div>
...
<body class="bg-slate-950 text-slate-100 min-h-screen overflow-x-hidden font-sans">
    ...
    <button id="sidebar-trigger" onclick="toggleSidebar(); hideSplash()" class="fixed left-4 bottom-16 z-40 bg-indigo-600 hover:bg-indigo-500 text-white p-3.5 rounded-full shadow-lg shadow-indigo-600/30 transition-all duration-300 hover:rotate-90" aria-label="Toggle Navigation">
